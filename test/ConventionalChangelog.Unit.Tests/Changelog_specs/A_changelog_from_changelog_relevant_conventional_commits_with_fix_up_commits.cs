...
public partial class A_changelog_from_changelog_relevant_conventional_commits
{
    public class With_fix_up_commits
    {
        ...
        public With_fix_up_commits()
        {
            ...
            _fixUp = CommitTypeFor.Feature.CommitWithDescription(2).WithFooter(FixUpToken, _target.Hash);
        }
        ...
        {
            var fixUp2 = CommitTypeFor.Feature.CommitWithDescription(3).WithFooter(FixUpToken, _fixUp.Hash);
        ...
        {
            var fixUp2 = CommitTypeFor.Feature.CommitWithDescription(3).WithFooter(FixUpToken, _target.Hash);
        ...
        {
            var fixUp2 = CommitTypeFor.Feature.CommitWithDescription(3).WithFooter(FixUpToken, "randomHash");
